...
GIT_HASH = 'fix_iot_thing_conflict'
COMMON_PARAMS = [
...
//                         )
                        ...
                        build(
                            ...
                            parameters: COMMON_PARAMS + [
                                ...
                                string(name: 'MASTER_NODE_LABEL', value: "ec2-us-west-2-prod"),
                                string(name: 'VIEWER_NODE_LABEL', value: "ec2-us-west-2-prod"),
