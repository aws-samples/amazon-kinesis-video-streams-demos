...
pipelineJob("${NAMESPACE}-orchestrator") {
    ...
    parameters {
        ...
        stringParam('GIT_HASH', 'metric-implementation', 'Git branch/tag/commit to use')
        ...
        booleanParam('RUN_STORAGE_LOW_FPS', true, 'Run StorageLowFps test (master + consumer at 10 fps, 156s)')
