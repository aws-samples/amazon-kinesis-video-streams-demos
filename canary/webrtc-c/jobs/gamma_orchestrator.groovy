        ...
        stage('Validate Parameters') {
            steps {
                script {
                    ...
                    if (!params.RUN_STORAGE_WITH_VIEWER && !params.RUN_STORAGE_TWO_VIEWERS && !params.RUN_STORAGE_THREE_VIEWERS && !params.RUN_STORAGE_PERIODIC && !params.RUN_STORAGE_SUB_RECONNECT && !params.RUN_STORAGE_SINGLE_RECONNECT && !params.RUN_STORAGE_LOW_FPS && !params.RUN_VO_MIXED_VIEWERS) {
