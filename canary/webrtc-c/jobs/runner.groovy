            ...
            steps {
                script {
                    ...
                    def assumeRoleOutput = sh(script: '''
                        export AWS_KVS_STS_ROLE_ARN=${roleArn}
                        aws sts assume-role --role-arn $AWS_KVS_STS_ROLE_ARN --role-session-name roleSessionName --duration-seconds 43200 --output json''',
