...
public final class CanaryConstants {
    ...
    public static final String SUB_RECONNECT_LABEL = "WebrtcStorageSubReconnect";
    public static final String SINGLE_RECONNECT_LABEL = "WebrtcStorageSingleReconnect";
    public static final String EXTENDED_LABEL = "WebrtcStorageExtended";
    public static final String PERIODIC_LABEL = "WebrtcStoragePeriodic";
